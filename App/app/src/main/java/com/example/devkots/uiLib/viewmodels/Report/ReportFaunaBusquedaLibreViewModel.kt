...
class ReportFaunaBusquedaLibreViewModel(
    private val bioReportService: BioReportService,
    private val faunaBusquedaReportDao: FaunaBusquedaReportDao? = null
) : ViewModel() {
    ...
    private fun fetchReportFromDatabase(reportId: Int) {
        viewModelScope.launch {
            loading = true
            try {
                faunaBusquedaReportDao?.getFaunaBusquedaReportById(reportId.toLong())?.let {
                    report = it.toFaunaBusquedaReport()
                }
    ...
    fun updateReport(reportId: Int, updatedReport: FaunaBusquedaReport) {
        viewModelScope.launch {
            ...
            try {
                ...
                faunaBusquedaReportDao?.updateFaunaBusquedaReport(entity)
